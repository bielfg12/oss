...
switch ($_REQUEST["acao"]) {
    case "cadastrar":
        ...
        $sql = "INSERT INTO usuarios (email, nome_sobrenome, telefone, cpf, nome_login, senha, cep, rua, bairro, cidade, uf, numero, ip_local) VALUES 
        ('{$email}', '{$nome_sobrenome}', '{$telefone}', '{$cpf}', '{$nome_login}', '{$senha}', '{$cep}', '{$rua}', '{$bairro}', '{$cidade}', '{$uf}', '{$numero}', '{$ip}')";
        ...
        /*Janela popup para indicar que foi cadastrado com sucesso */
        if ($res == true) {
            print "<script>alert('Cadastrado com sucesso!');</script>";
            print "<script>location.href='http://hotspot.agil.local/login?dst=http://www.cmctelecom.com.br';</script>"; 
        } else {
            /*Janela popup para indicar que NÃO FOI cadastrado com sucesso */
